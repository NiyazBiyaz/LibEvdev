...
// This file was automatically generated using /usr/include/linux/input-event-codes.h.
// Run ConvertCodeToEnums.fsx with input-event-codes.h in the same directory if it differs in your system.

namespace LibEvdev.Native
{
    public enum Synchronization : ushort
    {
        SYN_REPORT = 0x0,
        SYN_CONFIG = 0x1,
        SYN_MT_REPORT = 0x2,
